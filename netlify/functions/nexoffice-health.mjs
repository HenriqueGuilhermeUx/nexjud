...
export default async (req) => {
  ...
  try {
    const response = await fetch(`${baseUrl}/v1/platform/health`, {
      headers: { accept: 'application/json', 'x-nexoffice-key': internalKey },
      signal: AbortSignal.timeout(8_000),
    });
    ...
    return json(200, {
      ...
      externalEffects: payload?.externalEffects === true,
    });
  } catch (error) {
